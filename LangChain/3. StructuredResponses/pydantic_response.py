...
class Schema(BaseModel):
    key_thmes: list[str] = Field(description="write down all the key themens discussed in the review in a list")
    summary: str = Field(description="brief summary of the review")
    sentiment: Literal["pos", "neg"] = Field(description="write down the sentiment of the review")
    pros: Optional[list[str]] = Field(default=None, description="write down all the pros inside a list")
    cons: Optional[list[str]] = Field(default=None, description="write down all the cons inside a list")
    name: Optional[str] = Field(default=None, description="Write down the name of the reviewer if there is one")
